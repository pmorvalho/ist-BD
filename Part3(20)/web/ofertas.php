...
<?php
    try
    {
        ...
        echo("<tr><td><a href=\"escolhealugavel.php\">Adicionar Oferta</a></td></tr>\n");
        ...
        foreach($result as $row)
        {
            ...
            echo("<td><a href=\"removeoferta.php?morada={$row['morada']}&codigo={$row['codigo']}&data_inicio={$row['data_inicio']}\">Remover Oferta</a></td>\n");
            echo("</tr>\n");
        }
